...
\AuthorDeclarationImageFile{Figures/prohlaseni.jpg}
...
\CzechKeywords{SQL, databáze, SŘBD, simulace vytížení, validace SQL, Java, JavaFX, JDBC}
...
\EnglishKeywords{SQL, database, DBMS, workload simulation, SQL validation, Java, JavaFX, JDBC}
